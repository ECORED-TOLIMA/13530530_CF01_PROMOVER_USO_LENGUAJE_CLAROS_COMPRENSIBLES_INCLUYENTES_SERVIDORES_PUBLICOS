...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    #t_6_1.titulo-segundo.color-acento-contenido(data-aos="fade-left")
      h2 6.1 Características de la información pública
    figure.mb-4
    ...
    .row.align-items-center.mb-4
      .col-lg-8.mb-4.mb-lg-0
        LineaTiempoD.color-acento-botones
          ...
          p.mb-0(numero="3" titulo="Oportuna") La información debe publicarse o entregarse a tiempo para que pueda ser utilizada.
          p.mb-0(numero="4" titulo="Veracidad") Los datos deben corresponder con la realidad institucional y normativa.
    ...
    .titulo-pastilla.mt-4(data-aos="fade-down")
      ...
      span Tipos de información pública
    ...
    .titulo-sexto.color-acento-contenido.mb-3.mt-4
      h5 Tabla 3.
      span Tipos de información pública, propósito y ejemplo
    .tabla-a.color-acento-contenido.tema1-tabla.mb-4
      table
        thead
          tr
            th Tipo de información pública
            th Propósito
            th Ejemplo
        tbody
          tr
            td #[strong Información institucional.]
            td Dar a conocer la entidad, sus funciones, canales y responsabilidades.
            td Misión, horarios de atención, sedes y datos de contacto.
          tr
            td #[strong Información normativa.]
            td Explicar normas, decisiones, acuerdos, resoluciones o lineamientos.
            td Publicación de una resolución que regula un trámite.
          tr
            td #[strong Información de trámites.]
            td Orientar a la ciudadanía sobre pasos, requisitos, costos, plazos y canales.
            td Guía para solicitar un certificado.
          tr
            td #[strong Información de servicios.]
            td Presentar programas, beneficios o rutas de atención disponibles.
            td Información sobre atención a población vulnerable.
          tr
            td #[strong Información contractual y presupuestal.]
            td Divulgar el uso de recursos públicos y procesos de contratación.
            td Publicación de contratos, planes de compra o presupuesto.
          tr
            td #[strong Información de participación.]
            td Convocar a la ciudadanía a opinar, proponer, decidir o hacer seguimiento.
            td Invitación a una audiencia pública o consulta ciudadana.
          tr
            td #[strong Información de respuesta.]
            td Contestar solicitudes, peticiones, quejas, reclamos o requerimientos.
            td Respuesta escrita a una petición ciudadana.
          tr
            td #[strong Información preventiva o pedagógica.]
            td Promover comportamientos, cuidados o comprensión de temas públicos.
            td Campaña de prevención o guía explicativa sobre derechos.
    .row.justify-content-center.mb-4
      .col-lg-10
        .cajon.color-secundario.p-4
          p.mb-0 Identificar el tipo de información pública es importante porque ayuda a definir la estructura del mensaje según su propósito. Por ejemplo, una convocatoria debe incluir fechas, requisitos y canales de participación; una respuesta institucional necesita explicar la decisión y las razones que la sustentan; mientras que un trámite debe indicar qué hacer, qué documentos presentar, dónde realizar el procedimiento y el tiempo estimado para su atención.

    .titulo-pastilla.mt-4(data-aos="fade-down")
      img(src="@/assets/curso/icon.svg" alt="")
      span Acceso a la información pública
    p.mb-4 El acceso a la información pública significa que la ciudadanía puede conocer, consultar y usar la información que se encuentra en el poder de las entidades públicas. Este acceso no debe entenderse únicamente como la posibilidad de ingresar a un sitio web o descargar un documento, el acceso también implica que la información sea presentada en condiciones que faciliten su comprensión.
    ...
    .row.justify-content-center.mb-4
      .col-md-6.col-xl-4.mb-4.mb-xl-0
        .tarjeta-avatar
          img(src="@/assets/curso/temas/t6/img5.svg" alt="")
          .tarjeta.color-primario.w-100.h-100.mt-3
            .p-4
              h5.text-center 1. Encontrar la información
              p.mb-0 Si la información existe, pero es difícil de encontrar, el acceso se limita.
      .col-md-6.col-xl-4.mb-4.mb-xl-0
        .tarjeta-avatar
          img(src="@/assets/curso/temas/t6/img6.svg" alt="")
          .tarjeta.color-primario.w-100.h-100.mt-3
            .p-4
              h5.text-center 2. Comprender la información
              p.mb-0 Si la información se encuentra, pero está escrita con un lenguaje técnico, la comprensión se dificulta.
      .col-md-6.col-xl-4.mb-0
        .tarjeta-avatar
          img(src="@/assets/curso/temas/t6/img7.svg" alt="")
          .tarjeta.color-primario.w-100.h-100.mt-3
            .p-4
              h5.text-center 3. Usar la información
              p.mb-0 Si la información se comprende, pero no indica qué hacer, la ciudadanía puede confundirse porque no cuenta con orientación.
    ...
    .row.align-items-center.mb-4
      ...
      .col-lg-7
        ...
        ul.lista-ul.mb-4
          ...
          li
            i.fas.fa-comment-dots
            | La accesibilidad del formato.
        .cajon.color-primario.p-4
          p.mb-0 Estos aspectos ayudan a que la información pueda ser comprensible por más personas sin que se pierda la precisión institucional.
